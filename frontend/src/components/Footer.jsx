                ...
                <div className='grid gap-12 lg:grid-cols-12 lg:gap-10'>
                    ...
                    <div className='lg:col-span-3'>
                        ...
                        <ul className='mb-6 flex flex-col gap-3 text-sm text-emerald-900/80'>
                            <li>
                                <a
                                    href='https://wa.me/923353232164'
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    className='inline-flex flex-wrap items-center gap-x-2 gap-y-1 transition-colors hover:text-emerald-700'
                                >
                                    <span className='font-medium text-emerald-950'>WhatsApp</span>
                                    <span>+92 335 3232164</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    href='mailto:contact.kamayabi@info.com'
                                    className='break-all transition-colors hover:text-emerald-700 hover:underline'
                                >
                        ...
                        <div className='flex flex-wrap items-center gap-3 text-emerald-950'>
                            <a
                                href='https://www.tiktok.com/@kamayabi'
                                target='_blank'
                                rel='noopener noreferrer'
                                aria-label='KAMAYABI on TikTok'
                                className='flex h-10 w-10 items-center justify-center rounded-full border border-emerald-200/90 bg-white/80 text-emerald-900 shadow-sm transition-all hover:border-emerald-300 hover:bg-emerald-50'
                            >
                                <svg
